...
8. 当前本地验收通过：恢复工具 4 项测试、后端 177 项测试、数据库 35 项测试、Vue 生产构建。
...
6. `/api/health` 与 `/health/database` 均返回 `OK`；本地后端 177 项、数据库 35 项、恢复工具 4 项测试及 Vue 生产构建通过。
...
6. 本地后端 177 项、数据库 35 项测试和 Vue 生产构建通过；云端部署标记为 `5bc4b40`，对应 API 修复提交为 `93c1e57`。
